...
export const DDayBox = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed max-w-184 left-1/2 -translate-x-1/2 bottom-50 z-10 px-7 py-4 rounded-2xl bg-white/30 backdrop-blur-md border border-white/60 shadow-[0_4px_24px_rgba(0,0,0,0.13)] flex flex-col items-center gap-2"
    >
